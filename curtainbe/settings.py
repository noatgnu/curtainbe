...
CURTAIN_ALLOW_USER_SET_PERMANENT = False

# Umami Analytics Configuration
UMAMI_WEBSITE_ID = os.environ.get('UMAMI_WEBSITE_ID', '')
UMAMI_WEBSITE_ID_CURTAIN = os.environ.get('UMAMI_WEBSITE_ID_CURTAIN', UMAMI_WEBSITE_ID)
UMAMI_WEBSITE_ID_CURTAINPTM = os.environ.get('UMAMI_WEBSITE_ID_CURTAINPTM', UMAMI_WEBSITE_ID)
...
if os.environ.get("WORKING_ENV") == "PRODUCTION":
    ...
    if os.environ.get("CURTAIN_ALLOW_USER_SET_PERMANENT"):
        v = int(os.environ.get("CURTAIN_ALLOW_USER_SET_PERMANENT"))
        if v == 1:
            CURTAIN_ALLOW_USER_SET_PERMANENT = True
        else:
            CURTAIN_ALLOW_USER_SET_PERMANENT = False
