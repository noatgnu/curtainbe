...
class DataCiteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = DataCite
        fields = ["id", "updated", "created", "curtain", "curtain_type", "collection", "doi", "status", "user", "title", "form_data", "contact_email", "pii_statement", "lock", "local_file", "public_file_url", "error_message"]
